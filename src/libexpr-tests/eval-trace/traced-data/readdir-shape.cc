...
TEST_F(TracedDataTest, ReadDir_ContainerProvenance_LostAfterUpdate)
{
...
TEST_F(TracedDataTest, ReadDir_NestedDirs_IndependentOverrides)
{
    TempDir td1;
    td1.addFile("a", "x");
...
TEST_F(TracedDataTest, ReadDir_LargeDirectory_SpecificEntryAccessed)
{
    TempDir td;
    // Create 100 entries
    for (int i = 0; i < 100; i++)
