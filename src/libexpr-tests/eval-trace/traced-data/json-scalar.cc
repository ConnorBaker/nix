...
TEST_F(TracedDataTest, JSON_ScalarAccess_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_NestedAccess_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_UnusedKeyChange_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_UsedKeyChange_CacheMiss)
{
...
TEST_F(TracedDataTest, JSON_AddKey_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_RemoveUnusedKey_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_RemoveUsedKey_CacheMiss)
{
...
TEST_F(TracedDataTest, JSON_ArrayAccess_CacheHit)
{
...
TEST_F(TracedDataTest, JSON_ArrayElementChange_AccessedVsUnaccessed)
{
    TempJsonFile file(R"({"items": ["alpha", "beta", "gamma"]})");
    auto expr = R"(let j = builtins.fromJSON (builtins.readFile )" + file.path.string() + R"(); in builtins.elemAt j.items 1)";
