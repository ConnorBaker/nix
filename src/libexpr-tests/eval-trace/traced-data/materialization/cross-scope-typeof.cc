...
TEST_F(MaterializationDepTest, CrossScope_TypeOf_TypeChange_CacheMiss)
{
...

    {
        ...
        // Name says "CacheMiss" but typeOf's SC #type dep is unchanged by
        // key addition — structural override serves the cached result.
        EXPECT_EQ(loaderCalls, 0)
            << "typeOf: SC #type dep survives key addition → warm hit";
    }
}
