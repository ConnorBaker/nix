...
TEST_F(DepPrecisionTest, DirSet_HasKeyMiss_MultiDir_ProducesAggregateDep)
{
    ...
    size_t dirSetDeps = countJsonDeps(deps, CanonicalQueryKind::StructuredProjection,
    ...
    size_t individualDirHasKey = countJsonDeps(deps, CanonicalQueryKind::StructuredProjection,
    ...
    bool foundCorrectDep = hasJsonDep(deps, CanonicalQueryKind::StructuredProjection,
        [](const nlohmann::json & j) {
...
TEST_F(DepPrecisionTest, DirSet_HasKeyHit_StillIndividualDep)
{
    ...
    bool foundHit = hasJsonDep(deps, CanonicalQueryKind::StructuredProjection,
        [](const nlohmann::json & j) {
    ...
    bool foundAggregated = hasJsonDep(deps, CanonicalQueryKind::StructuredProjection,
        [](const nlohmann::json & j) {
...
TEST_F(DepPrecisionTest, DirSet_SingleDir_NoAggregation)
{
    ...
    bool found = hasJsonDep(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("missing"));
    EXPECT_TRUE(found)
...
TEST_F(DepPrecisionTest, DirSet_JsonOrigins_NeverAggregated)
{
    ...
    size_t hasKeyDeps = countJsonDeps(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("missing"));
...
TEST_F(DepPrecisionTest, DirSet_MixedDirAndJson_OnlyDirsAggregated)
{
    ...
    size_t jsonHasKey = countJsonDeps(deps, CanonicalQueryKind::StructuredProjection,
        [](const nlohmann::json & j) {
...
TEST_F(DepPrecisionTest, DirSet_Hash_IsDeterministic)
{
