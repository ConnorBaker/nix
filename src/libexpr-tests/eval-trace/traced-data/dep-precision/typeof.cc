...
TEST_F(DepPrecisionTypeOfTest, TypeOf_IsAttrs_RecordsSCType)
{
    TempJsonFile file(R"({"data": {"a": 1}})");
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_IsList_RecordsSCType)
{
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_IsString_NoTypeDep)
{
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_IsInt_NoTypeDep)
{
    TempJsonFile file(R"({"x": 42})");
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_IsBool_NoTypeDep)
{
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_TypeUnchanged_CacheHit)
{
...
TEST_F(DepPrecisionTypeOfTest, TypeOf_NestedTypeChange_CacheMiss)
{
