...
TEST_F(DepPrecisionAttrKeysMultiTest, PartialOverlap_SCKeys_NotRecordedForShadowed)
{
    ...
    size_t scKeysCount = countJsonDeps(deps, CanonicalQueryKind::StructuredProjection, shapePred("keys"));
...
TEST_F(DepPrecisionAttrKeysMultiTest, AttrKeys_IntersectAttrs_RecordsHasKeyDeps)
{
    TempJsonFile fileA(R"({"x": 1, "y": 2})");
    TempJsonFile fileB(R"({"x": 10, "z": 30})");
    ...
    EXPECT_GE(countJsonDeps(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("x")), 2u)
    ...
    EXPECT_TRUE(hasJsonDep(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("z")))
...
TEST_F(DepPrecisionAttrKeysMultiTest, AttrKeys_IntersectAttrs_HasKeyDepsForAllKeys)
{
    ...
    EXPECT_TRUE(hasJsonDep(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("c")))
...
TEST_F(DepPrecisionAttrKeysMultiTest, IntersectAttrs_MultipleSharedKeys_AllGetHasDep)
{
    ...
    EXPECT_TRUE(hasJsonDep(deps, CanonicalQueryKind::StructuredProjection, hasKeyPred("w")))
