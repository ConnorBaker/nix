...
TEST_F(DepPrecisionPipelinesTest, Pipeline_FilterMapLength_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_AttrNamesMapListToAttrs_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_UpdateMapAttrsAttrNames_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_FilterSortLength_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_ConcatMapGroupByAttrNames_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_FoldlFilterPartition_CacheMiss)
{
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_NestedUpdateScalarAccess_CacheHit)
{
    ...
    {
        auto deps = evalAndCollectDeps(expr);
        EXPECT_TRUE(hasDep(deps, CanonicalQueryKind::StructuredProjection, "key"))
        ...
        EXPECT_FALSE(hasJsonDep(deps, CanonicalQueryKind::StructuredProjection, shapePred("keys")))
            << "No SC #keys from //\n" << dumpDeps(deps);
        EXPECT_GE(countJsonDeps(deps, CanonicalQueryKind::ImplicitStructure, shapePred("keys")), 3u)
...
TEST_F(DepPrecisionPipelinesTest, Pipeline_MapAttrsFilterAttrNames_CacheMiss)
{
