...
TEST_F(TracedDataTest, ReadDir_BasicAccess_CacheHit)
{
    TempDir td;
...
TEST_F(TracedDataTest, ReadDir_MultipleAccess_CacheHit)
{
    TempDir td;
    td.addFile("hello", "content");
    td.addSubdir("world");
...
TEST_F(TracedDataTest, ReadDir_SymlinkEntry_CacheHit)
{
    TempDir td;
    td.addFile("target", "x");
...
TEST_F(TracedDataTest, ReadDir_DirectoryEntry_CacheHit)
{
    TempDir td;
    td.addSubdir("subdir");
    td.addFile("file", "x");
...
TEST_F(TracedDataTest, ReadDir_SpecialCharKey_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_EmptyDir_CacheHit)
{
    TempDir td;
...
TEST_F(TracedDataTest, ReadDir_AddUnrelatedFile_CacheHit)
{
    TempDir td;
    td.addFile("hello", "content");
...
TEST_F(TracedDataTest, ReadDir_RemoveUnrelatedFile_CacheHit)
{
    TempDir td;
    td.addFile("hello", "content");
...
TEST_F(TracedDataTest, ReadDir_ChangeUnrelatedType_CacheHit)
{
    TempDir td;
    td.addFile("hello", "content");
...
TEST_F(TracedDataTest, ReadDir_ThroughUpdate_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_ThroughMapAttrs_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_MultiAccess_OneChangedCacheMiss)
{
    TempDir td;
    td.addFile("a", "x");
    td.addFile("b", "y");
...
TEST_F(TracedDataTest, ReadDir_AddMultipleFiles_CacheHit)
{
    TempDir td;
    td.addFile("hello", "content");
    auto expr = "(builtins.readDir " + td.path().string() + ").hello";
...
TEST_F(TracedDataTest, ReadDir_MixedContentAndDir_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_AccessedEntryTypeChanges_CacheMiss)
{
    TempDir td;
    td.addFile("hello", "content");
    td.addFile("other", "pad");
...
TEST_F(TracedDataTest, ReadDir_AccessedEntryRemoved_CacheMiss)
{
    TempDir td;
    td.addFile("hello", "content");
    td.addFile("other", "pad-pad");
...
TEST_F(TracedDataTest, ReadDir_NoValuesForced_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_AllEntriesChangedType_CacheHit)
{
    TempDir td;
    td.addFile("a", "x");
    td.addFile("b", "y");
...
TEST_F(TracedDataTest, ReadDir_OneAccessedOneChanged_CacheMiss)
{
    TempDir td;
    td.addFile("a", "x");
    td.addFile("b", "y");
...
TEST_F(TracedDataTest, ReadDir_MapAttrsIgnoreValues_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_AccessedEntryReplacedSameType_CacheHit)
{
...
TEST_F(TracedDataTest, ReadDir_MixedInvalid_CacheMiss)
{
