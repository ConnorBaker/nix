...
// RawContent dep (QueryBehavior::Normal, not overrideable) via maybeRecordRawContentDep.
...
TEST_F(TracedDataTest, RawContent_SingleReadFileBothWays_BlocksOverride)
{
