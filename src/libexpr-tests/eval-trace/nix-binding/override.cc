...
TEST_F(NixBindingOverrideTest, NixBinding_ScopeChange_InvalidatesAll)
{
...
TEST_F(NixBindingOverrideTest, NixBinding_LambdaFormalChange_InvalidatesAll)
{
...
TEST_F(NixBindingOverrideTest, NixBinding_BecomeRecursive_CacheMiss)
{
    TempTestFile file("{ x = 1; y = 2; }");
    auto expr = std::format("(import {}).x", file.path.string());
...
TEST_F(NixBindingOverrideTest, NixBinding_UpdateOperator_LhsTracked)
{
...
TEST_F(NixBindingOverrideTest, NixBinding_InheritFromSourceChange_CacheMiss)
{
...
TEST_F(NixBindingOverrideTest, NixBinding_LetScopeUnrelatedChange_CacheHit)
{
